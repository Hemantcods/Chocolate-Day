...
const ViewLink = () => {
  ...
  useGSAP(() => {
    if (isOpened) {
      gsap.utils.toArray(".chocolate").forEach((el) => {
        gsap.fromTo(
          el,
          {
            yPercent: -40,
  ...
  return (
    ...
    <div className="absolute z-1 w-full h-full flex justify-center items-center">
      <div ref={containerRef} className="relative h-screen w-full overflow-hidden ">
        <div className="chocolate absolute w-20 left-[10%]">
          <img src={choclate} />
        </div>
        <div className="chocolate absolute w-20 left-[20%]">
          <img src={choclate} />
        </div>
        <div className="chocolate absolute w-20 left-[40%]">
          <img src={choclate} />
        </div>
        <div className="chocolate absolute w-20 left-[60%]">
          <img src={choclate} />
        </div>
        <div className="chocolate absolute w-20 left-[80%]">
          <img src={choclate} />
        </div>
    </div>
      ...
      <div
        className={`upper h-screen w-full flex flex-col justify-center items-center bg-pink-200 cursor-pointer absolute z-10 ${isOpened ? "hidden" : "block"}`}
        onClick={() => setIsOpened(true)}
      >
        <h1 className="text-3xl text-pink-600 font-bold mb-8">
          You have a surprise! 🎁
        </h1>
        <video
          src={giftAnimation}
        ...
        />
        <p className="text-pink-500 mt-8 text-xl animate-bounce">
          Click to open
        </p>
      </div>
      <div className="h-screen w-full flex justify-center items-center relative bg-pink-100">
        <div
          ...
          style={{
            backgroundImage: `url(${choclate})`,
            backgroundSize: "40px",
            backgroundRepeat: "space",
          }}
        ></div>
        <div className="h-screen w-full flex justify-center items-center absolute z-2">
          <div className="bg-pink-400 h-100 w-200 rounded-2xl flex flex-col justify-center items-center gap-5">
            <h3 className="text-2xl text-white pb-5">
              You received a Chocolate! 🍫
            </h3>
            <div className="name">
